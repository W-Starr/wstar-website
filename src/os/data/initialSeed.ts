...
export const initialSources: import('@/os/types').Source[] = [
  ...
  },
  {
    ...
    sourceType: 'gdrive',
    provider: 'google_drive',
    title: 'WSTAR Corporate Letterhead SOP & Communications Ledger',
    summary:
      'Standard operating procedure governing official company letterheads, CAC compliance under CAMA 2020 Sections 304/729, department reference codes (EXEC, TECH, HR, CAG, OPS), and correspondence logs.',
    externalUrl: 'https://docs.google.com/document/d/1WSTAR_Letterhead_SOP_CorporateRecords/edit',
    mimeType: 'application/vnd.google-apps.document',
    author: 'Management & Technology Operations',
    relatedProductId: 'wstar-core',
    aiStatus: 'analyzed',
    aiSummary:
      'Compliance and governance standard establishing official letterhead templates, mandatory board signatures, and centralized communications reference logging.',
    tags: ['Governance', 'SOP', 'Letterhead', 'CAC'],
  ...
  },
  {
    ...
    sourceType: 'gdrive',
    provider: 'google_drive',
    title: 'WSTAR Brand Guidelines & Vector Visual Identity',
    summary:
      'Canonical corporate brand book specifying Montserrat / Inter typography hierarchy, official hex palette, and vector SVG logo locks.',
    externalUrl: 'https://docs.google.com/document/d/1WSTAR_BrandGuidelines_VisualIdentity_CAG/edit',
    mimeType: 'application/vnd.google-apps.document',
    author: 'Management & Technology Operations',
    relatedProductId: 'wstar-core',
    aiStatus: 'analyzed',
    aiSummary:
      'Brand standards guide eliminating generic design tells, mandating high-contrast editorial typography, and standardizing logo usage.',
    tags: ['Brand', 'Typography', 'Logo Assets', 'Design'],
