...
export const initialWorkItems: WorkItem[] = [
  ...
  // ==========================================
  {
    ...
    description:
      'The boilerplate widget test pumps `const MyApp()` without initializing Firebase or Riverpod ProviderScope, immediately failing CI pipelines. Must delete or update with mock providers.',
    bugMetadata: {
  ...
  },
  {
    ...
    description:
      'When tapping an undownloaded topic in the syllabus path, the UI redirects to the old DownloadManagerScreen instead of showing the in-line contextual download confirmation dialog.',
    bugMetadata: {
  ...
  },
  {
    ...
    description:
      'Attempting to `.update({\'lastStudiedAt\': ...})` throws `NOT_FOUND` on brand new user enrollments where the progress document does not yet exist. Must use `.set(..., SetOptions(merge: true))`.',
  ...
  },
  {
    ...
    description:
      'Tapping an active course in the Home Dashboard does nothing because the card lacks an `InkWell` / `onTap` navigation handler to `StudyPathScreen`.',
  ...
  },
  {
    ...
    description:
      'Firestore SDK restricts `whereIn` queries to 30 items maximum. When questionIds.length > 30, query throws an unhandled client exception. Must chunk question IDs into sub-batches of 30.',
    createdAt: '2026-08-17T08:20:00Z',
    updatedAt: '2026-08-17T08:20:00Z',
  },
  {
    id: 'item-6',
    itemNumber: 'DEBT-001',
    ...
    description:
      'Firebase Admin SDK private service keys and Android keystore release certificates must be explicitly ignored in `.gitignore` to prevent credential exposure.',
    createdAt: '2026-08-17T08:25:00Z',
    updatedAt: '2026-08-17T08:25:00Z',
  },
  {
    id: 'item-7',
    itemNumber: 'DEBT-002',
    ...
    description:
      'Accidental IDE import generated a duplicate folder `package.cloud_firestore`. Also clean up unused 2-line placeholder `home_screen.dart`.',
